...
// Builds JSON snapshots and ws.textAll()s them. Single source of all
// server-push traffic — pages and controllers don't talk to the socket
// directly.
class StateBroadcaster {
public:
  StateBroadcaster(AsyncWebSocket &ws, PetFSM &fsm, BleHid &ble,
                   DeviceSlots &slots)
