...
public:
    ...
    // Swallow the next button event — call immediately after esp_light_sleep_start()
    // returns to discard the wakeup press before it reaches the navigation callback.
